...
function Definitions() {
    ...
    return (<div className="col ps-xl-4 ps-0 mt-xl-0 mt-5">
                ...
                <p><b>Big O Notation:</b> &nbsp;A tool used to describe the time complexity relative to n. To simplify, the time it takes to sort the array relative to the input size.</p>
                <br/>
